...
public class HomeProductController {
    ...
    @GetMapping("/products")
    public List<ProductDTO> getProducts(@RequestParam String tab) {
        switch (tab) {
            case "all":
                return mainProductService.getProductsForAll();
            case "tea":
                return mainProductService.getProductsForTea();
            case "coffee":
                return mainProductService.getProductsForCoffee();
            case "tools":
                return mainProductService.getProductsForAccessories();
            default:
